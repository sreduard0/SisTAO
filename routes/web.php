...
Route::post('loginsubmit', [LoginController::class, 'login_submit'])->name('login_submit');
Route::get('logout', [LoginController::class, 'logout'])->name('logout');

//======== PAINEL DE CONTROLE
Route::get('home', [MainController::class, 'home'])->name('home');
Route::get('profile/{id?}', [MainController::class, 'profile'])->name('profile');
Route::get('profile/editprofile/{id?}', [MainController::class, 'edit_profile'])->name('edit_profile');
...
Route::get('profile/createuser', [MainController::class, 'create_user'])->name('create_user');
Route::get('profile/deleteprofile/{id}', [CrudController::class, 'delete_profile'])->name('delete_profile');
