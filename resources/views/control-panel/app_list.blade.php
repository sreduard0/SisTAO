                        ...
                        <div class="form-group col">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" id="loading_post" name='loading_post'
                                    value="1">
                                <label for="loading_post" class="custom-control-label">Login via script</label><br>
                                <span style="font-size:14px ">Para sites com login via JS.</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group col">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" id="loadingpost" name='loadingpost'
                                    value="1">
                                <label for="loadingpost" class="custom-control-label">Login via script</label><br>
                                <span style="font-size:14px ">Para sites com login via JS.</span>
                            </div>
                        </div>
