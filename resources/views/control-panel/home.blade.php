                                                    ...
                                                    <script>
                                                        function postToIframe{{ $app->id }}() {
                                                            $('#formapps').append(
                                                                ...
                                                                ' <div id="div{{ $app->id }}" ><form id="login{{ $app->id }}" target="_blank" action="{{ $app->apps[0]->link }}" method="post"><input type="hidden" name="{{ $app->apps[0]->inputUser }}" value="{{ $app->user }}"><input type="hidden" name="{{ $app->apps[0]->inputPass }}" value="{{ $app->password }}"></form></div>'
                                                            );
