...
// fim
            ...
            $.ajax({
                ...
                url: window.location.origin+"/upload_img_profile",
                type: "POST",
                data: {
                ...
                success: function(data) {
                    ...
                    document.getElementById("img_profile").src = window.location.origin+'/' + data;
                    document.getElementById("image_profile").src = window.location.origin+'/' + data;
                }
            });
        })
    });
